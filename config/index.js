...
var PLATFORM = process.env.PLATFORM || 'runestake';
var mongoUri = 'mongodb://localhost:27017/runestake';
...
var defaults = {
	...
	SMTP: {
		...
		SENDER: 'Big Heart <runestake@yopmail.com>',
	},
	FCM: {
		API_KEY: 'FCM_API_KEY'
	},
	...
	mongoDB: {
		...
		NAME: process.env.DB_NAME || 'runestake',
		USER: process.env.DB_USERNAME || 'user',
		PASSWORD: process.env.DB_PASSWORD || 'password',
		get URL() { return process.env.dbUrl || `${this.PROTOCOL}://${this.USER}:${this.PASSWORD}@${this.HOST}:${this.PORT}/${this.NAME}?authSource=admin` }
	},
	domain: {
